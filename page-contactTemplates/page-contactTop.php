<section class="contactTop">
    ...
    <figure class="contactTop__img">
        <img src="<?php echo esc_url(get_template_directory_uri()); ?>/img/cta.png" alt="お問い合わせ画像:PCに打ち込んでいる" class="contactTop__img--s">
        <h2 class="subPage__title h2__title--white">お問い合わせ・資料請求</h2>
    </figure>
