<header class="firstView">
    ...
    <div class="firstViewInner">
        <figure class="topImg">
            <img src="<?php echo esc_url(get_template_directory_uri()); ?>/img/top.jpg" alt="トップ画像:先生が生徒に教えている" class="topImg__item">
        </figure>
        <div class="firstViewText">
            <h1 class="firstViewText__title">TOEFL対策はEngress</h1>
            <p class="firstViewText__subtitle">日本人へのTOEFL指導歴豊かな講師陣の<br>コーチング型TOEFLスクール</p>
            <a href="#" class="firstViewText__btn btn__round btn--yellow">資料請求</a>
            <a class="firstViewText__toContact">お問い合わせ</a>
        </div>
    </div>
    <!-- first-view__inner -->
